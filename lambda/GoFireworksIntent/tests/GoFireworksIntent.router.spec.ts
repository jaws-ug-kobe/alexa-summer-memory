...
import { GoFireworksIntentRouter } from '../GoFireworksIntent.router'

describe('GoFireworksIntentRouter', () => {
  let handler: RequestHandler;
  beforeEach(() => {
    handler = RequestHandlerFactory.create(GoFireworksIntentRouter);
  });
  describe('canHandle', () => {
