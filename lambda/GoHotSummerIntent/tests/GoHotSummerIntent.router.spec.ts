...
import { GoHotSummerIntentRouter } from '../GoHotSummerIntent.router'

describe('GoHotSummerIntentRouter', () => {
  let handler: RequestHandler;
  beforeEach(() => {
    handler = RequestHandlerFactory.create(GoHotSummerIntentRouter);
  });
  describe('canHandle', () => {
