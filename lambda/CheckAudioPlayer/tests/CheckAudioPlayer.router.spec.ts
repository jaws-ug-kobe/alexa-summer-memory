...
import { CheckAudioPlayerRouter } from '../CheckAudioPlayer.router'

describe('CheckAudioPlayerRouter', () => {
  let handler: RequestHandler;
  beforeEach(() => {
    handler = RequestHandlerFactory.create(CheckAudioPlayerRouter);
  });
  describe('canHandle', () => {
